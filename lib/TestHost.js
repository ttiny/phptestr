...
@def constructor TestHost ( dir:string, phpbin:string = "php" )
@param Directory where too look for configuration file and/or scripts.
*/
function TestHost ( dir, phpbin ) {
...
TestHost.define( {
	...
	_runOne: function ( test, args, testcallback, done ) {
		...
		var phpargs = [ __dirname + '/run_test_script.php', testfn, JSON.stringify(args), this.InitScript ];
